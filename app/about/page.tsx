function AboutPage() {
  return (
    <section className="text-center py-16 bg-white rounded-sm shadow-sm">
      <h1 className="text-4xl font-extrabold tracking-tight text-slate-800 sm:text-6xl">
        Welcome to
      ...
      <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
        ...
        that the best ideas come from hands-on experience. Explore. Create.
        Inspire.
      </p>
    </section>
  );
